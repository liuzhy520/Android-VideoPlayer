...
public class ExampleMPActivity extends Activity implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.examplemp_activity);
...
//                Intent intent = new Intent(ExampleMPActivity.this, UseWidgetActivity.class);
...
//				}
    ...
    private void playVideo() throws IllegalArgumentException,
        ...
        String legendWing = "http://legendwing.com/videos/LOVE-128.mp4";
        this.mediaPlayer = new MediaPlayer();
        this.mediaPlayer.setDataSource(legendWing);
        this.mediaPlayer.setDisplay(this.surfaceHolder);
        this.mediaPlayer.prepareAsync();
        this.mediaPlayer.start();
//        this.mediaPlayer.create(this, Uri.parse(legendWing),this.surfaceHolder);
